interface IOptions {
  code: string;
  debug?: boolean;
  analytics?(...args: (string | IPageViewOptions | IEventOptions | IExceptionOptions)[]): void;
}
...
export class Tracker {
  ...
  constructor(options: IOptions) {
    ...
    this.analytics = this.options.debug || !this.options.analytics ? this.log : this.options.analytics;
  ...
  private log(...args: (string | IPageViewOptions | IEventOptions | IExceptionOptions)[]): void {
